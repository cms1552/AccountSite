...
<body class="bg-light">
	...
	<div class="row g-5">
			...
			<div class="col-md-7 col-lg-8">
				...
				<form class="needs-validation" name="signup" method="post" action="/subject2/Modify">
					<div class="row g-3">
							<div class="col-sm-6">
				...
				<button class="w-50 btn btn-primary btn-md" type="button" onclick="checkForm()">회원수정</button>
				</form>
